...
- `example-composition/` — structured agents, provider-specific options and capability preflight, stable sequential items,
  parallel lanes, pipelines, settled helpers, and children.
- `example-humans-and-waits/` — gates, ask/approve, editable or view-only repository artifacts, attachments, signals,
  and durable sleep.
...
`examples/coverage.json` maps every public `Ctx`
